            ...
            ?> 
                ...
                <div class="load_more load_more_buttom">
                   <div class="button-container">
                        <a class="btn-quake-load quake-load-more" data-page="<?php echo quake_check_paged(1); ?>" data-archive="<?php echo quake_grab_current_uri(); ?>" data-url="<?php echo admin_url('admin-ajax.php'); ?>">
                            <span class="quake-icon fa fa-refresh"></span>
